...
namespace Gm\Backend\Config\IpBlackList\Controller;
...
/**
 *  Контроллер чёрного списка IP-адресов.
 * 
 * @author Anton Tivonenko <anton.tivonenko@gmail.com>
 * @package Gm\Backend\Config\IpBlackList\Controller
 * @since 1.0
 */
class Grid extends GridController
{
     ...
     * {@inheritdoc}
     * 
     * @var BaseModule|\Gm\Backend\Config\IpBlackList\Extension
     */
    ...
    public function createWidget(): TabGrid
    {
        ...
        $tab->grid->columns = [
            ...
            [
                ...
                'cellTip'   => HtmlGrid::tags([
                    ...
                    ['fieldset',
                        [
                            HtmlGrid::legend($this->t('IP address are not available for')),
                            HtmlGrid::fieldLabel(
                                $this->t('for backend'), 
            ...
            [
                'text'      => '#Note',
                'tooltip'   => '#Reason for adding an IP address to the blacklist',
                'dataIndex' => 'note',
                'cellTip'   => '{note}',
                'filter'    => ['type' => 'string'],
                'sortable'  => true,
                ...
                'search' => [
                    'items' => [
                        ...
                        'filter' => ExtGrid::popupFilter([
                            [
                                'xtype' => 'label',
                                'text'  => '#IP addresses are not available for:',
                                'ui'    => 'header'
                            ],
                            [
                                'xtype'      => 'radio',
        ...
        $tab->navigator->info['tpl'] = HtmlNav::tags([
            ...
            ['fieldset',
                [
                    HtmlNav::legend($this->t('IP address are not available for')),
                    HtmlNav::fieldLabel(
