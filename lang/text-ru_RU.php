...
return [
    '{name}'        => 'Чёрный список IP-адресов',
    '{description}' => 'Запрет доступа пользователям к Панели управления или сайту с указанных IP-адресов',
    '{permissions}' => [
        'any'  => ['Полный доступ', 'Настройка чёрного списка IP-адресов']
    ],
    ...
    'Note' => 'Причина',
    'Reason for adding an IP address to the blacklist' => 'Причина добавления IP-адреса в чёрный список',
    ...
    'IP address are not available for' => 'IP-адрес не доступен для',
